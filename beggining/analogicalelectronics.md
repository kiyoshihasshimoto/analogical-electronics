...
A eletrônica analógica é muito importante para o desenvolvimento de um equipamento. É aqui que iremos preparar o terreno da energia que iremos utilizar... Divindo a tensão, limitando a corrente em pontos específicos, reduzindo ou até limpando os ruídos e imperfeições da energia.

Isso tudo é necessário para que, ao desenvolver um sistema, todo o sinal elétrico que recebermos, **ele deve estar limpo**, sem oscilações para que evite falhas na geração do resultado desejado.
